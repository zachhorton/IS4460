<?php 
    ...
    $query = "SELECT parent_id, first_name, last_name FROM parent";
		...
		<div class="container-fluid">
        		<form method ="post" action="../controller/add_student_controller.php">
        			<div class="form-group">
        				...
        				<input type="text" class="form-control" placeholder="First Name" name="student_first_name">
        			</div>
        			...
        			<div class="form-group">
        				...
        				<input type="text" class="form-control" placeholder="Last Name" name="student_last_name">
        			</div>
        			...
        			<div class="form-group">
        				...
        				<input type="text" class="form-control" placeholder="Baptism Certificate" name="baptism_certificate">
        			</div>
